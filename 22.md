...
<figure>
	<img src="/news/images/22/principia_wasm_3.webp" style="max-width:960px" alt="Screenshot of Principia running with the browser address bar visible at the top.">
...
Earlier this autumn the [official Principia community site archive](/archive) previously hosted at archive.principia-web.se has been merged into the main site. While there was a historical reason for the split (the archive was originally hosted by Bithack on the original Principia server), it no longer makes sense [now that I fully operate both of them](https://voxelmanip.se/2024/08/25/archiving-the-archive/), and only seems to cause confusion for players.
...
- A [pastebin service](/paste) allowing users to upload and share LuaScript code, log files or other text content.
- A [file uploader](/uploader) allowing users to upload and share files, e.g. for sharing screenshots and other images on the [forums](/forum/) instead of relying on third-party image hosting services that are subject to link rot after some time.
...
Finally, [a new chat](/chat) has been added to the site. If you've been around for a while you may remember the previous chat on this site that was essentially just a comments section and was decommissioned in early 2024. This new chat is closer to the dynamic chat that used to be on the old community site back in the day.
